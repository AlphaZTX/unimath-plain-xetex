...
\def\ttverbatim{\begingroup
  ...
  \catcode`\&=12 \catcode`\#=12 \catcode`\%=12 \catcode`\~=12
  \catcode`\_=12 \catcode`\^=12 \obeyspaces \obeylines \tentt}
...
\smallskip
\begingroup\leftskip=4pc\rightskip=4pc\parindent=1.5pc
{\sf\umpx} package provides OpenType math font support in {\it plain \tex\/} 
format. The {\sf\umpx} package needs \xetex.\par\endgroup

% TOC
\bigskip
\centerline{\bf Contents}
\smallskip
\begingroup\leftskip=4pc\rightskip=4pc\parindent=0pc\parskip0pt\relax
